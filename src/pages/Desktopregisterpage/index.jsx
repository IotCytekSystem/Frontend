        ...
        <div className="absolute bg-black-900 flex flex-col h-full inset-[0] items-start justify-center m-auto w-full">
          <div className="flex md:flex-col flex-row md:gap-10 gap-[69px] items-center justify-start md:px-5 w-[95%] md:w-full">
            ...
            <div className="flex flex-col gap-[29px] justify-start w-[32%] md:w-full">
              <Text
                className="md:ml-[0] ml-[198px] text-white-A700 text-xl"
              ...
              <div className="md:h-[656px] h-[663px] relative w-full">
                <div className="absolute flex flex-col gap-[21px] items-start justify-start left-[0] top-[0] w-[74%]">
                  ...
                  <div className="flex flex-col gap-[5px] items-start justify-start w-full">
                    ...
                    >
                      ...
                      <span className="text-purple-500 font-poppins text-left font-semibold">
                        Login here !
                      </span>
                    </Text>
                  </div>
                ...
                <div className="absolute bg-purple-500 bottom-[0] flex flex-col inset-x-[0] items-center justify-end mx-auto p-[11px] rounded-[26px] shadow-bs w-full">
                  <a
                    href="javascript:"
                    className="mt-1 text-[17px] text-white-A700"
                  >
                ...
                <div className="absolute flex flex-col h-full inset-[0] items-start justify-center m-auto w-full">
                  <div className="flex flex-col gap-[21px] items-start justify-start w-[74%] md:w-full">
                    <Text
                      className="text-3xl sm:text-[26px] md:text-[28px] text-white-A700"
                      size="txtPoppinsMedium30"
                    >
                    ...
                    <div className="flex flex-col gap-[5px] items-start justify-start w-full">
                      ...
                      >
                        ...
                        <span className="text-yellow-A200 font-poppins text-left font-semibold">
                          Login here !
                        </span>
                      </Text>
                    </div>
                  </div>
                  <div className="flex flex-col gap-3 items-start justify-start mt-[50px] w-full">
                    <Text
                      className="text-[13px] text-white-A700"
                      size="txtPoppinsMedium13"
                    >
...
export default DesktopregisterpagePage;
